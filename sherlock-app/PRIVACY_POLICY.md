...
- ❌ Aucun **contact, photo ou calendrier** de votre appareil
...
- ❌ Exploitée pour vous profiler

---

## 4. Où sont stockées vos données ?

Vos données sont hébergées par **Google Firebase**, sur des serveurs situés dans l'Union Européenne (région `europe-west`).

Google Firebase est certifié conforme au **RGPD**. Vous pouvez consulter la politique de confidentialité de Google Cloud à l'adresse : [cloud.google.com/security/privacy](https://cloud.google.com/security/privacy).
...
L'Application est conçue pour les **adultes (parents, éducateurs)** souhaitant mieux comprendre leurs enfants via la grille de lecture de l'Ennéagramme.

L'Application **n'est pas destinée aux enfants de moins de 13 ans**.

Si vous êtes mineur, merci de ne pas créer de compte sans le consentement de vos parents ou tuteurs légaux.

---

## 10. Modifications de cette politique

Nous pouvons modifier cette politique de confidentialité. En cas de modification substantielle, vous serez informé au prochain lancement de l'Application.
...
*Cette politique de confidentialité est rédigée en français et constitue la version qui fait foi.*
