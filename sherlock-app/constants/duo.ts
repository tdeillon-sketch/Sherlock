...
export const DUO_PARENT_VIEW: Record<string, PerspectiveView> = {
  ...
  "1-1": {
    ...
    parentSoutien: "Vous croyez l'aider à viser plus haut ; vous validez sa pire petite voix. Quand il ramène un 18/20 et que votre première phrase est « c'était quoi, les deux points ? », vous ne corrigez pas un détail technique — vous donnez raison à la voix qui lui souffle déjà « tu n'es jamais assez ». Il pensait avoir bien fait. Il comprend qu'il n'a jamais bien fait. Cette équation, posée par celui dont il a le plus besoin, ne se déconstruit pas.",
    parentChallenge: "Ce que vous appelez ses « défauts » est exactement ce que votre conjoint·e essaie de vous dire de vous depuis des années. Sa tension permanente, son besoin d'avoir raison, son incapacité à lâcher — vous les supportez d'autant moins chez lui que vous les reconnaissez sans pouvoir le nommer. Le corriger, c'est continuer à vous taire à vous-même. Tant que vous ne déposerez pas vos propres armes, lui n'apprendra qu'à mieux fourbir les siennes.",
  },
  "1-2": {
    ...
    parentSoutien: "Pour cet enfant, son dessin n'est pas un dessin — c'est un acte d'amour qui attend d'être reçu. Quand votre premier réflexe est « oh, tu as dépassé ici », vous corrigez un trait, mais lui entend que son amour n'est pas recevable tel quel. À force, il vérifiera avant de donner. Et ce qu'il offrira plus tard sera plus prudent, moins vrai, moins lui.",
    parentChallenge: "Cet enfant vous aime gratuitement, et c'est ça qui vous déstabilise. Votre tête cherche le retour d'ascenseur, la réciprocité « méritée », l'ordre juste de l'amour. Sa tendresse sans condition vous désoriente parce que vous n'avez jamais appris à la recevoir comme ça. Lui apprendre à mériter l'amour, c'est lui transmettre le vide dans lequel vous avez grandi.",
  },
  "1-3": {
    ...
    parentSoutien: "Pour cet enfant, votre « mais » ampute toute victoire. Quand il gagne sa compétition et que vous dites « bravo, mais tu aurais pu serrer ton coude », vous croyez l'aider à progresser ; lui comprend que son succès ne vaut rien en lui-même. Il ira chercher le « presque-parfait » de plus en plus haut, espérant que votre phrase s'arrête un jour avant le « mais ». Elle ne s'arrêtera pas tant que vous ne réglez pas, vous, cette phrase dans votre tête.",
    parentChallenge: "C'est l'enfant que vous auriez voulu être — visible, brillant, adoré. Et c'est précisément ce qui vous trouble : il est admiré pour ce qui n'est pas noble à vos yeux, alors que vous avez sué pour l'excellence invisible. Votre exigence cache peut-être une jalousie inavouable pour cet accès facile au regard des autres. La nommer ne la fera pas disparaître. La taire, en revanche, l'amplifiera.",
  },
  "1-4": {
    ...
    parentSoutien: "Pour lui, son monde intérieur est le seul endroit où il existe vraiment. Quand il pleure pour la troisième fois cette semaine et que vous lâchez « arrête, c'est rien », vous ne consolez pas — vous lui annoncez que ce qu'il a de plus vrai n'a pas sa place chez vous. Il continuera à pleurer, mais ailleurs, seul. Et vous direz « il est si secret », sans voir que c'est vous qui avez fermé la porte.",
    parentChallenge: "Sa sensibilité vous dérange parce qu'elle révèle la vôtre — celle que vous avez convertie très tôt en rigueur pour ne plus avoir à la sentir. Vous n'avez pas supprimé votre fragilité, vous l'avez habillée en exigence morale. Cet enfant, lui, refuse cette conversion. Il vit tout ce que vous avez enterré — et c'est pour ça que vous le trouvez « difficile ».",
  },
  "1-5": {
    ...
    parentSoutien: "Pour cet enfant, votre interruption « bienveillante » est une rupture violente. Quand vous entrez dans sa chambre pour la cinquième fois avec une consigne et qu'il ne lève pas les yeux, vous prenez ça pour de l'insolence — il était simplement entré dans son monde. Chaque rappel à l'ordre lui apprend que sa concentration n'est pas respectable. Il ne vous désobéira pas frontalement. Il deviendra juste expert en fuite invisible.",
    parentChallenge: "Son autonomie tranquille vous fait mal sans que vous sachiez pourquoi. Vous avez construit votre valeur en étant irréprochable devant quelqu'un — lui construit la sienne sans regard. Son indépendance vous renvoie à votre dépendance au jugement extérieur. Vous voulez le cadrer « pour son bien » : en vérité, pour retrouver le contrôle que sa distance vous fait perdre.",
  },
  "1-6": {
    ...
    parentSoutien: "Vos critiques, même justes, deviennent chez lui des micro-séismes. Vous avez dit « demain on fait tel truc », un imprévu surgit, vous laissez tomber sans en faire une affaire — pour lui, vigilant, la promesse cassée s'inscrit. Il n'apprend pas vos règles : il apprend à avoir peur de vous. Et cette peur ne le rendra pas docile, juste anxieux à vie.",
    parentChallenge: "Son anxiété vous agace parce qu'elle est la vôtre, en version sonore. Vous aussi scannez le monde pour les failles, mais vous appelez ça de la lucidité. Lui n'a pas encore construit cette façade de rigueur — il avoue sa peur, sans filtre, et c'est sa vulnérabilité qui vous met en colère. Ce n'est pas lui que vous voulez faire taire : c'est votre propre peur, qu'il révèle.",
  },
  "1-7": {
    ...
    parentSoutien: "Quand il débarque avec quinze idées en cinq minutes et que vous répondez « finis d'abord ce que tu as déjà commencé », ce n'est pas de la pédagogie — c'est votre peur du bazar déguisée en sagesse. Vous lui apprenez chaque jour que ses élans joyeux sont un problème à gérer. Un jour il cessera d'avoir des élans. Et ce jour-là, vous en pleurerez.",
    parentChallenge: "Sa joie pure vous agace, même si vous ne l'admettrez jamais : vous le trouvez « pas assez sérieux ». La vérité, c'est que vous prenez tout trop au sérieux depuis toujours, et son insouciance vous rappelle ce qu'on vous a interdit très tôt. Il vous offre, gratuitement, ce que personne ne vous a appris : qu'on peut être heureux sans l'avoir mérité.",
  },
  "1-8": {
    ...
    parentSoutien: "Avec un 8 enfant, votre « tu ne me parles pas sur ce ton » lui apprend que la force brute (la vôtre) gagne contre l'argument honnête (le sien). Il vous défie frontalement, vous montez l'autorité — pour vous c'est respect, pour lui c'est la preuve que vous n'écoutez pas, vous imposez. Vous avez, dans ce petit moment, perdu la seule chose qu'il respecte vraiment : la justesse. Il vous testera plus dur la prochaine fois.",
  ...
  "1-9": {
    ...
    parentSoutien: "Son « oui » à tout n'est pas un accord — c'est une disparition. Vous êtes soulagé·e d'avoir un enfant facile, sans voir qu'il s'efface parce qu'il a compris très tôt que ses désirs n'ont pas leur place face à vos exigences. Vous pensez avoir un enfant docile. Vous aurez bientôt un enfant absent — physiquement présent, mais introuvable quand vous chercherez vraiment à le rencontrer.",
    parentChallenge: "Sa lenteur vous fait monter la mayonnaise comme rien d'autre. Ce n'est pas sa lenteur qui vous agace, c'est ce qu'elle révèle : que votre course acharnée n'est peut-être pas le seul rythme légitime. Chaque fois que vous le bousculez, vous défendez la nécessité de votre propre fuite en avant. Lui propose, simplement, un autre rythme.",
  },
  ...
  "2-1": {
    ...
    parentSoutien: "Pour ce petit 1, votre câlin immédiat n'est pas une consolation — c'est un message : ta peine m'est insupportable, va mieux tout de suite. Il a fait une bêtise, il s'en veut déjà, vous l'enlacez en disant « ce n'est rien chéri ». Il apprendra à cacher sa peine pour vous protéger. Et bientôt, il se cachera lui-même.",
    parentChallenge: "Cet enfant vous refuse — il veut gérer seul, il vous dit qu'il n'a pas besoin de vous. Ça pique : vous voulez être nécessaire, il vous dit que vous ne l'êtes pas toujours. C'est précisément la leçon que vous ne voulez pas entendre : votre valeur n'est pas dans votre utilité. Il la confirme tous les jours en vous aimant sans avoir besoin de vous.",
  },
  "2-2": {
    ...
    parentSoutien: "Quand il vous apporte la tasse de café avant que vous l'ayez demandée, vous êtes touché·e — mais regardez bien : il vous copie. Il apprend de vous que l'amour, c'est deviner les besoins de l'autre avant les siens. Cette leçon, vous l'avez payée cher toute votre vie. Vous êtes en train de la lui transmettre intégralement, avec votre reconnaissance en cadeau d'emballage.",
    parentChallenge: "Cet enfant est votre miroir, et ce qu'il vous renvoie vous gêne. Vous l'aimez par élan, oui — et aussi parce qu'il comble ce vide affectif que vous portez depuis toujours. Sa générosité vous nourrit plus que vous ne la nourrissez, dans un échange discrètement inversé. Pour le libérer du piège, il faudrait d'abord reconnaître que vous y êtes encore.",
  },
  "2-3": {
    ...
    parentSoutien: "Pour cet enfant, votre grand amour suit ses victoires — il l'apprendra très vite. Quand il rentre avec une super note et que vous appelez mamie, vous l'aimez sincèrement, mais il enregistre l'équation : performer = être célébré chez maman/papa. Il continuera à collectionner les trophées comme on nourrit quelqu'un qu'on a peur de perdre. Il ne s'arrêtera pas, même épuisé, parce que son carburant sera devenu votre regard.",
    parentChallenge: "Sa capacité à se vendre, à charmer, à « réussir socialement » vous gêne — vous y sentez quelque chose de calculé qui heurte votre croyance que l'amour est au-dessus des stratégies. Mais votre générosité est elle aussi une stratégie : plus élégante, plus discrète, mais une façon de vous rendre nécessaire. Lui fait juste la version visible de ce que vous faites en sourdine.",
  },
  "2-4": {
    ...
    parentSoutien: "Pour cet enfant, votre « dis-moi ce qui ne va pas » est une intrusion douce. Vous voulez consoler ; lui vit une demande déguisée d'aller mieux pour vous rassurer. Il apprendra à pleurer en silence, à vous épargner, à vivre ses tempêtes seul. Et vous lui en voudrez, plus tard, de ne plus rien partager.",
    parentChallenge: "Cet enfant refuse votre consolation au moment où vous en avez le plus envie. Vous voulez être celui ou celle qui sauve, lui préfère traverser sa nuit. Son repli vous prive de votre rôle, et c'est exactement votre travail : apprendre que l'aimer, parfois, c'est accepter de ne pas être utile. Peu de choses vous coûteront autant.",
  },
  "2-5": {
    ...
    parentSoutien: "Pour cet enfant, votre intrusion « pour son bien » est un prélèvement d'énergie. Vous entrez dans sa chambre avec un chocolat chaud et un sourire, il lève les yeux presque froid : « tu peux fermer la porte ? ». Vous croyez à un rejet ; il vous aime, mais à sa façon. Il apprendra que l'amour, c'est de l'envahissement légitimé.",
  ...
  "2-6": {
    ...
    parentSoutien: "Sa sécurité ne viendra pas de vos « oui je t'aime » à répétition — elle viendra de votre fiabilité silencieuse, celle qui ne quémande pas de « merci ». Il vous pose pour la dixième fois la même question rassurante, vous répondez patiemment, mais votre patience n'est pas neutre : il sent qu'il vous épuise, et ça ajoute à son anxiété au lieu de la calmer. Il a besoin d'un parent qui ne vacille pas. Pas d'un parent qui se sacrifie.",
    parentChallenge: "Sa méfiance instinctive vous blesse — vous donnez tant, et il doute de vous. Cette méfiance touche exactement là où ça fait mal : votre attente secrète de gratitude. Vous voulez être aimé·e en retour de ce que vous donnez. Lui vous demande de l'aimer sans solde, sans retour garanti — la seule forme d'amour qui puisse le sécuriser.",
  },
  "2-7": {
    ...
    parentSoutien: "Votre déception « non dite » est plus toxique que votre colère franche. Vous aviez prévu un moment ensemble, il s'est laissé happer ailleurs, vous lâchez « ce n'est pas grave, fais comme tu veux » avec ce ton-là. Il capte parfaitement votre déception enveloppée, et il apprendra à vous éviter pour ne pas sentir cette culpabilité collante. Vous perdrez exactement ce que vous cherchiez : sa présence libre.",
    parentChallenge: "Sa fuite vers l'ailleurs vous met à plat. Vous avez toujours cru qu'aimer, c'était être là, dispo, présent — il vous dit que parfois aimer c'est partir. Son désir de liberté vous confronte à votre dépendance affective, cette peur silencieuse d'être seul·e. Le libérer signifie lâcher la corde invisible — et sentir, peut-être pour la première fois, le vide qu'elle cachait.",
  },
  "2-8": {
    ...
    parentSoutien: "Avec cet enfant, votre demande affective camouflée se prend un « non » direct. Vous lui dites « tu pourrais être plus gentil avec ta sœur », il répond « non », sans agressivité, juste clair. Votre sang ne fait qu'un tour : comment ose-t-il ? Parce qu'il n'a pas encore appris que l'amour, c'est obéir à votre besoin déguisé en conseil. Votre travail n'est pas de le faire plier — c'est d'apprendre de lui qu'on peut dire non sans cesser d'aimer.",
    parentChallenge: "Cet enfant ne vous récompense pas, et ça vous brise quelque chose. Vous donnez, il ne remercie pas. Vous proposez, il prend ce qu'il veut. Votre Orgueil de bienfaiteur·rice se cogne à sa pure verticalité, et il vous oblige à choisir : continuer à donner pour obtenir, ou apprendre à donner juste parce que c'est donner. Seule la deuxième voie le gardera près de vous.",
  },
  "2-9": {
    ...
    parentSoutien: "Son « comme tu veux » n'est pas une coopération, c'est une inexistence. Vous lui demandez « tu préférerais A ou B ? », il répond toujours « comme tu veux » — il a compris très tôt que son désir pèse moins que votre envie de bien faire. Il vous donne de la paix, vous lui donnez de l'inexistence. L'échange est profondément inégal.",
    parentChallenge: "Son effacement vous rassure et vous alerte en même temps. Rassure parce qu'il ne conteste rien. Alerte parce qu'il ne vous demande rien non plus — et ça vous prive de votre rôle. Cet enfant vous oblige à aimer quelqu'un qui ne vous appelle pas. Accepter qu'il existe sans que vous l'aidiez à exister, c'est peut-être le plus grand cadeau que vous puissiez lui faire.",
  },
  ...
  "3-1": {
    ...
    parentSoutien: "Pour cet enfant, votre obsession du résultat ampute précisément ce qu'il a investi : la qualité du processus. Il vous montre son cahier impeccable, vous demandez « combien tu as eu ? ». Pour lui qui a mis son âme dans la forme, la forme comptait — il apprend que chez vous, le travail n'existe que s'il produit un trophée. Il optimisera bientôt ce qui se voit. Et méprisera ce qu'il aimait vraiment.",
    parentChallenge: "Sa lenteur minutieuse vous rend dingue — mais ce qui vous agace, c'est exactement ce que vous avez sacrifié : le soin pour le soin, le travail bien fait parce que c'est juste. Vous confondez son éthique avec de l'inefficacité. Lui, lucide, sent cette confusion. Et elle l'humilie.",
  },
  "3-2": {
    ...
    parentSoutien: "Quand il vous offre un dessin et que votre cerveau part déjà sur la prochaine tâche, vous ne dites rien de méchant — mais lui reste avec son dessin dans les mains, comprenant que l'affection qu'il tendait ne mérite pas une vraie pause. Il ne vous en voudra pas. Il apprendra juste à tendre moins, et à se consoler tout seul.",
    parentChallenge: "Cet enfant vous aime pour qui vous êtes quand vous ne performez pas. Et ça vous déstabilise, parce que vous ne savez pas qui vous êtes en dehors du rôle. Sa chaleur inconditionnelle vous met face au vide identitaire que vous avez comblé par l'action. Le recevoir vraiment exigerait d'arrêter la course. Vous ne savez pas comment.",
  },
  "3-3": {
  ...
  "3-4": {
    ...
    parentSoutien: "Quand vous lui dites « tu es doué, fais quelque chose », vous voulez le sortir de sa chambre — lui entend que ce qu'il fait là-dedans ne compte pas. Ce que vous appelez « doué » touche rarement ce qui compte pour lui. Il apprendra à cacher ses passions mal rentables, ou à les abandonner. Ce qu'il appelait son monde deviendra sa honte.",
    parentChallenge: "Sa profondeur sans trophée vous déroute — il peut passer une heure sur une émotion sans rien produire. Vous ressentez alors un malaise : et si la vie n'était pas faite que de KPIs ? Cet enfant pose la question que vous avez enterrée à 12 ans pour vous permettre de fonctionner. La réveiller maintenant, c'est renégocier ce que vous avez cru être votre force.",
  },
  "3-5": {
    ...
    parentSoutien: "Quand il lit depuis deux heures un truc sur les oiseaux migrateurs et que vous lui dites « c'est pas ce qui est noté, concentre-toi », vous ne le ramenez pas au travail — vous lui apprenez que la connaissance n'a de valeur que si elle est validée par un système. Il deviendra peut-être un bon élève. Et un adulte qui a perdu sa curiosité.",
    parentChallenge: "Son indifférence à votre regard vous blesse secrètement. Vous avez bâti votre identité sur l'admiration reçue, lui refuse le jeu : il pense seul, il s'intéresse seul, il ne vous demande pas de valider. Ce que vous appelez sa « distance » est en réalité sa souveraineté — et elle vous confronte à tout ce que vous avez cédé pour être aimé·e des autres.",
  },
  "3-6": {
    ...
    parentSoutien: "Quand il dit « et si je n'y arrive pas ? » et que vous répondez en mode coach « mais si, vas-y ! », votre intention est juste — votre effet, dévastateur. Il sent que vous ne prenez pas sa peur au sérieux, que vous êtes déjà passé·e à la phase « mobilisation ». Il apprendra à simuler la confiance pour vous rassurer, tout en portant son doute seul. Sa peur ne disparaîtra pas — elle deviendra juste invisible.",
    parentChallenge: "Sa prudence vous exaspère — pourquoi ne fonce-t-il pas ? Mais cette prudence est précisément ce que votre jeunesse a écrasé en vous. Vous avez foncé, oui, et vous avez construit. Mais vous avez aussi perdu la permission de dire « je ne sais pas ». Lui l'habite naturellement, et ça réveille en vous une nostalgie que vous ne savez pas nommer.",
  },
  "3-7": {
    ...
    parentSoutien: "Quand vous lui dites « finis au moins un truc », votre intention est de le discipliner — son entendement est : même la joie pure doit produire un résultat. Vous voulez le structurer ; en réalité vous voulez qu'il devienne un petit vous, efficace et focalisé. Il finira par choisir un seul chemin. Pas le sien : le vôtre.",
    parentChallenge: "Sa dispersion joyeuse vous heurte parce qu'elle ressemble à ce que vous appelez « le manque de caractère ». Mais regardez mieux : lui vit, vous performez. Il prend ce que la vie offre sans avoir besoin de prouver. Vous, vous ne goûtez rien sans objectif. Son gaspillage apparent vous renvoie à votre propre pénurie affective.",
  },
  "3-8": {
    ...
    parentSoutien: "Avec un 8 enfant, votre autorité de statut ne sert à rien — il ne respecte que l'autorité incarnée. Il refuse votre façon de faire, frontalement, vous haussez le niveau, vous mobilisez votre rôle de parent : il s'en moque. Chaque fois que vous tentez de le faire plier par position, vous perdez son respect. Et chez lui, le respect perdu est très dur à reconstruire.",
    parentChallenge: "Cet enfant ne peut pas être géré — et ça vous enrage parce que vous gérez tout, partout, toujours. Sa pure volonté vous rappelle que l'image et la stratégie ne fonctionnent que sur ceux qui les respectent. Lui non. Vous êtes obligé·e de revenir à ce que vous avez laissé derrière vous à 10 ans : la vérité brute, le mot qui tient, l'engagement sans paillettes. C'est brutal.",
  },
  "3-9": {
    ...
    parentSoutien: "Quand il vous suit sans protester et que tout votre entourage vous félicite pour cet enfant « facile », personne ne voit qu'il disparaît. Il se plie à votre programme parce qu'il n'a pas appris à revendiquer un espace. Vous construisez sa vie pendant qu'il se dissout. Un jour il ne répondra plus. Et vous ne comprendrez pas pourquoi.",
    parentChallenge: "Sa lenteur, son non-engagement, ce moule où rien ne s'imprime — tout ça vous exaspère. Mais son inertie est l'exact contraire de votre fuite en avant, et elle vous oblige à rester immobile avec lui. Dans cette immobilité, une vérité remonte : vous courez peut-être pour ne pas avoir à vous rencontrer. Lui, en ne bougeant pas, vous propose ce rendez-vous.",
  },
  ...
  "4-1": {
    ...
    parentSoutien: "Pour ce petit 1, votre vague émotionnelle partagée n'est pas une éducation à la vie intérieure — c'est une incertitude fondatrice. Vous traversez une phase intense, vous partagez vos états avec tous, lui inclus. Il apprendra à marcher sur des œufs, à surveiller votre visage avant de construire le sien. Vous lui transmettez un radar, pas un sol.",
  ...
  "4-2": {
    ...
    parentSoutien: "Quand il vous offre un câlin spontané et que votre tête part dans un passé triste, vous lui rendez le câlin sans y être. Son petit cœur sent la distance immédiatement, même à 4 ans. Il apprendra à se contenter d'un amour tiède — ou pire, à devenir le psychologue de son parent pour obtenir un peu de votre présence pleine.",
    parentChallenge: "Cet enfant vous aime de façon simple, fluide, inconditionnelle — et ça vous trouble parce que vous n'avez jamais cru possible qu'on vous aime sans complication. Vous cherchez le sens profond de son amour, vous le compliquez, vous le questionnez. Lui veut juste être là avec vous. Recevoir sa simplicité, c'est admettre que l'amour n'a pas toujours besoin d'être intense pour être vrai.",
  },
  "4-3": {
    ...
    parentSoutien: "Pour cet enfant, votre « l'important c'est pas ça » derrière une victoire est un rejet de sa joie. Il gagne une compétition, content ; vous félicitez en relativisant — il reçoit : maman/papa trouve ma joie superficielle. Il apprendra à célébrer ailleurs, avec ceux qui savent juste dire « bravo » sans appuyer sur le frein. Et vous direz, plus tard : « il ne me parle plus de ses succès ».",
  ...
  "4-4": {
    ...
    parentSoutien: "Pour ce petit 4, votre mélancolie partagée n'est pas une intimité — c'est un nid dont il ne sortira pas. Vous êtes tous deux dans la même ambiance grise un dimanche, vous vous comprenez sans parler ; vous trouvez ça beau. Il apprend, de vous, que la tristesse partagée est plus intime que la joie partagée. Il cherchera toute sa vie des partenaires qui partagent la nuit.",
    parentChallenge: "Cet enfant est votre miroir, et il vous charme autant qu'il vous effraie. Vous reconnaissez chaque oscillation, chaque phase sombre. Vous voulez le sauver de ce qui vous a abîmé·e — et en même temps vous adorez cette intimité commune. Le libérer exige de choisir : entretenir votre lien privilégié dans la douleur, ou l'aider à en sortir au prix de moins de communion. La seconde voie est plus solitaire pour vous.",
  },
  "4-5": {
    ...
    parentSoutien: "Pour cet enfant, vos questions « comment tu te sens ? » sont des ponctions d'énergie. Vous voulez le reconnecter, savoir ce qu'il pense ; lui, dans sa bulle mentale, ressent une intrusion bien intentionnée. Il apprendra à simuler la conversation, à donner le minimum pour que vous le laissiez tranquille, tout en se sentant coupable de cette stratégie. Vous chercherez sa profondeur exactement là où vous l'aurez vous-même fait fuir.",
    parentChallenge: "Sa capacité à vivre sans ressentir intensément vous déstabilise profondément. Vous pensez qu'il manque quelque chose — il pense la même chose de vous. Sa frugalité émotionnelle n'est pas une pauvreté, c'est un autre langage. La reconnaître vous oblige à remettre en cause votre croyance centrale : que ressentir fort égale vivre vrai. Vous ne voulez pas de cette remise en cause. Elle est pourtant juste.",
  },
  "4-6": {
    ...
    parentSoutien: "Votre authenticité émotionnelle est, pour un 6, une catastrophe invisible. Vous traversez une tempête intérieure et vous le lui montrez — visage défait, soupir profond — vous croyez être transparent·e. Lui, hyper-vigilant, capte votre orage comme une menace vitale. Ses nuits se peuplent de scénarios, son anxiété explose, et vous ne comprendrez jamais d'où elle vient.",
  ...
  "4-8": {
    ...
    parentSoutien: "Quand vous lui demandez d'être « plus doux » avec sa sœur, vous croyez parler de sophistication intérieure — pour lui, la douceur est un mensonge social. Il écrase en jeu, vous le reprenez ; chaque invitation à « nuancer » le coupe de sa vitalité brute. Celle-là même qui vous fascine et vous fait peur à la fois. Il apprendra à se retenir, ou à exploser. Pas de troisième option.",
  ...
  "4-9": {
    ...
    parentSoutien: "Vous proposez une « discussion importante », il dit oui ; pendant que vous parlez avec intensité, il hoche la tête mais son regard est ailleurs. Vous croyez qu'il écoute. Il se protège. Votre densité émotionnelle le submerge, et il a appris à être présent dans le corps, absent dans la tête. Il aura sa vie entière cette stratégie de fusion invisible pour survivre aux gens trop intenses.",
    parentChallenge: "Son effacement vous exaspère et vous attriste. Mais regardez bien : il s'efface parce que votre présence prend tout l'air. Votre Envie cherche constamment la singularité — la vôtre, celle des autres, la profondeur — et lui disparaît dans votre quête. Le rencontrer demande de lui laisser d'abord un espace où vous n'êtes pas. C'est votre travail le plus dur.",
  },
  ...
  "5-1": {
    ...
    parentSoutien: "Cet enfant ne lit pas vos mots, il lit vos yeux. Quand il vient vous montrer son dessin et que vous dites « c'est bien » sans lever la tête, il n'entend pas un compliment — il enregistre une absence. Il en conclura, sans vous le dire, que ses efforts ne méritent pas votre regard. Adulte, il cherchera l'approbation partout. Sauf la sienne.",
    parentChallenge: "Vous appelez ça « respecter son autonomie ». Pour lui, c'est un désert. Cet enfant n'est pas trop demandant — vous êtes trop économe, et la distance que vous croyez protectrice produit exactement l'anxiété que vous lui reprochez. Le pire : il finira par s'aligner sur vous, retiendra ses élans, et vous féliciterez sa maturité. C'est une perte que personne ne nommera.",
  },
  "5-2": {
    ...
    parentSoutien: "Pour cet enfant, votre économie d'énergie est une amputation de la sienne. Il vient dans votre bureau pour raconter sa journée, débordant ; vous êtes dans un problème intellectuel, vous répondez distrait·e. Il repart, moins brillant qu'en entrant. Il apprendra que son flux vital est une nuisance pour ceux qu'il aime — et il le muselera, jusqu'à ne plus savoir comment on raconte sa journée.",
  ...
  "5-3": {
    ...
    parentSoutien: "Pour cet enfant, votre approbation rationnelle ne vaut rien sans l'éclat dans le regard. Il revient avec sa médaille, l'agite devant vous ; votre cerveau évalue : « c'est bien, continue ». Il attend autre chose qu'il n'aura pas. Il ira le chercher ailleurs, avec une intensité qui grandira chaque année. Vous aurez construit, sans le vouloir, un adulte dépendant du regard des autres.",
    parentChallenge: "Son besoin constant d'être vu vous semble vulgaire, presque. Vous avez construit votre valeur dans l'invisibilité, dans le travail souterrain, dans la connaissance qui ne s'affiche pas. Lui affirme le contraire : il veut être regardé. Votre silence n'est pas de la profondeur à ses yeux — c'est un manque. Il vous confronte à la possibilité que la visibilité soit aussi une forme de vie légitime.",
  },
  "5-4": {
    ...
    parentSoutien: "Quand il pleure pour quelque chose qui vous semble disproportionné et que vous demandez « mais pourquoi tu réagis comme ça ? », votre intention est de comprendre — son vécu est : vous cherchez à invalider son émotion par la logique. Il apprendra à ne plus partager ses états avec vous. Vous continuerez à le penser « mystérieux ». C'est vous qui avez fermé la porte.",
  ...
  "5-5": {
    ...
    parentSoutien: "Vous appelez ça « respect mutuel ». Lui apprend, de vous, que l'amour entre proches ressemble à une cohabitation courtoise. Vous êtes deux dans la même pièce, chacun dans son monde, personne ne dérange personne. Il construira ses relations adultes sur ce modèle — propres, économiques, sans friction. Et il se demandera, plus tard, pourquoi rien ne le bouleverse jamais.",
  ...
  "5-6": {
    ...
    parentSoutien: "Pour cet enfant, votre « je l'ai dit, non ? » agacé est une rupture de sécurité. Il vient vous demander pour la sixième fois si vous serez là demain — il n'a pas besoin de l'information, il a besoin du lien. Chaque « oui je serai là » dit avec chaleur est une brique. Votre réponse aride lui confirme que votre amour est conditionnel à sa sobriété émotionnelle. Il l'apprendra.",
  ...
  "5-7": {
    ...
    parentSoutien: "Pour cet enfant, votre écoute économique est une déception qui s'inscrit. Il bavarde avec enthousiasme, vous notez juste les points principaux ; il sent votre absence, mais continue. Vous lui apprenez sans le vouloir que son énergie est trop pour les autres. Un jour il baissera le volume. Son étincelle, qui fait son charme, se ternira d'abord en votre présence.",
  ...
  "5-8": {
    ...
    parentSoutien: "Pour cet enfant, expliquer c'est faiblir. Quand il conteste une règle, vous argumentez calmement — vous croyez tenir bon, il entend que vous n'êtes pas sûr·e. Chaque démonstration est une porte qu'il pousse un peu plus. Il ne vous respectera pas pour vos bonnes raisons, mais pour votre capacité à dire non sans en donner. Votre autorité n'est pas dans votre tête : elle est dans votre corps qui ne bouge pas.",
    parentChallenge: "Il vient vous chercher exactement là où vous vous êtes retiré·e : dans le corps, dans la confrontation directe, dans la puissance non discutée. Chaque négociation est un signal — il ne cherche pas à gagner, il cherche un mur. Tant que vous resterez dans la tête, il continuera à frapper. Le jour où vous tiendrez debout sans argumenter, vous verrez : il se posera. C'est lui qui vous apprend à habiter votre autorité.",
  },
  "5-9": {
    ...
    parentSoutien: "Pour cet enfant, votre absence active est une confirmation que sa présence n'intéresse pas. Vous êtes soulagé·e d'avoir un enfant calme qui ne vous prélève pas d'énergie — mais cet enfant vous ressemble par défaut, pas par choix. Il s'effacera tout seul, sans drame. Vous ne remarquerez rien avant très tard.",
  ...
  "6-1": {
    ...
    parentSoutien: "Pour ce petit 1 anxieux, votre alliance dans la prudence n'est pas un cadeau — c'est une prison à deux. Vous, anxieux·se, lui aussi : vous renforcez son cadre avec encore plus de règles « pour son bien ». Deux anxiétés se nourrissent, et il comprend que le monde est dangereux et qu'il faut se surveiller en permanence. Vous reproduisez en lui exactement ce que votre enfance a fait de vous.",
    parentChallenge: "Son autocritique vous fait écho — vous reconnaissez l'anxiété morale, ce « et si j'avais mal fait ? ». Mais en voulant le rassurer, vous validez sa peur au lieu de la contester. Ce qu'il lui faut, c'est quelqu'un qui ose dire « c'est pas grave » sans inquiétude. Pour le faire pour lui, il vous faudrait d'abord vous le dire à vous.",
  },
  "6-2": {
    ...
    parentSoutien: "Pour cet enfant qui vous offre son cœur, votre vigilance « bienveillante » lui apprend que la proximité s'accompagne d'une enquête. Il vous câline, cherche votre affection — vous scannez ce qu'il pourrait taire : « tu as eu un problème à l'école ? ». Il apprendra à vous rassurer avant lui-même. Son amour deviendra, sans que vous le voyiez, un travail de sécurisation.",
  ...
  "6-3": {
    ...
    parentSoutien: "Quand il rentre avec un projet ambitieux et que votre premier réflexe est d'énumérer les risques, vous croyez le protéger — il reçoit que vous ne lui faites pas confiance. Il apprendra à ne plus partager ses élans avant d'avoir sécurisé lui-même le terrain. Ou à les réaliser en cachette, avec cette petite honte d'avoir osé.",
  ...
  "6-4": {
    ...
    parentSoutien: "Quand il est dans une phase sombre et que vous entrez en consultation intérieure « faut-il s'alarmer ? », vos questions anxieuses lui confirment que ses émotions sont effectivement dangereuses. Il apprendra à les gérer seul pour ne pas vous alarmer, ou à les amplifier pour vous garder proche. Dans les deux cas, ses émotions deviennent un théâtre. Pas un territoire.",
  ...
  "6-5": {
    ...
    parentSoutien: "Pour cet enfant, votre vérification « bienveillante » est une intrusion dans son seul refuge. Il est dans sa bulle, il lit, il ne vous répond pas tout de suite — votre anxiété monte, vous entrez dans sa chambre. Il apprendra à fermer davantage, à communiquer moins, à vous épargner l'alerte. Vous perdrez l'accès à son monde précisément à force de vouloir le vérifier.",
    parentChallenge: "Son retrait tranquille vous inquiète parce qu'il est hors de portée de votre vigilance. Vous ne pouvez pas le contrôler, vous ne pouvez pas anticiper. Cet enfant vous demande ce qui vous coûte le plus : faire confiance sans vérifier. Son autonomie silencieuse vous renvoie à votre peur de lâcher le volant. Il vous apprend que l'amour peut être aussi le fait de ne pas savoir.",
  },
  "6-6": {
    ...
    parentSoutien: "Vous pensez créer de la complicité par la vigilance partagée — vous construisez un écosystème de peur permanente. Vous êtes deux scanners qui s'activent mutuellement. Chaque « et si » que vous validez chez lui devient un « et si » de plus qu'il portera à vie. Votre alliance dans l'inquiétude est un poison doux.",
  ...
  "6-7": {
    ...
    parentSoutien: "Vos « fais attention » répétés ne sont pas de l'amour vigilant — c'est une dose quotidienne de doute injectée dans son moteur. Il prend un risque, vous lâchez la phrase ; vous la répétez dix fois par jour. Il commencera à hésiter là où il n'hésitait pas. À entendre votre voix au moment de décider. À associer aventure et peur parentale.",
    parentChallenge: "Son optimisme naturel vous heurte presque physiquement. Comment peut-il ne pas voir les dangers ? Vous l'enviez en secret, et cette envie devient parfois colère. Cet enfant incarne ce que votre vigilance vous a enlevé : la confiance de base que le monde ne va pas s'effondrer. L'admettre, c'est reconnaître que votre peur ne vous a pas protégé·e — elle vous a juste amputé·e.",
  },
  "6-8": {
    ...
    parentSoutien: "Avec un 8 enfant, votre contrôle anxieux est illisible — il n'y voit ni force ni justice, juste un parent qui a peur. Il vous défie, votre anxiété explose, vous serrez les boulons, vous multipliez les règles. Il ne vous obéit pas pour autant. Il testera davantage, parce qu'il cherche la vraie autorité — celle qui ne tremble pas — et il ne la trouve pas chez vous.",
  ...
  "6-9": {
    ...
    parentSoutien: "Quand il vous dit « ça va » et que vous fermez les yeux par épuisement, son calme vous soulage — au moins un front de moins à surveiller. Mais vous savez que ce n'est pas vrai, et lui apprend que le « ça va » est un cadeau qu'il vous fait. Plus tard, vous ne saurez pas ce qu'il ressent vraiment. Et vous ne saurez pas comment vous en êtes arrivé·e là.",
    parentChallenge: "Son calme apparent vous rassure à court terme et vous trouble au fond. Vous sentez qu'il y a quelque chose sous la surface lisse, mais vous n'osez pas y toucher — par peur de révéler un truc que vous ne sauriez pas gérer. Cet enfant vous met devant un choix inconfortable : préserver votre paix fragile, ou aller chercher la sienne dans les profondeurs. La deuxième option demande une énergie que vous ne savez pas si vous avez.",
  },
  ...
  "7-1": {
    ...
    parentSoutien: "Pour ce petit 1, votre fluidité créative n'est pas un cadeau — c'est l'absence des repères qu'il vous réclame. Il vous demande un cadre, des règles, des horaires ; vous lui répondez avec une version souple, négociable. Il apprendra à poser ses propres règles, compensatoirement rigides, pour survivre à votre flottement. Il sera bien plus rigide que vous n'auriez imaginé qu'il puisse l'être.",
    parentChallenge: "Son besoin de rigueur vous fatigue et vous agace — pourquoi faut-il tout cadrer ? Mais cet enfant pointe précisément ce que votre gourmandise a évité : l'engagement soutenu, la contrainte choisie, la profondeur qui exige de ne pas papillonner. Votre flèche de désintégration vers le 1 s'éveille à son contact. Pour l'aimer, il faut accepter qu'il vous oblige à atterrir.",
  },
  "7-2": {
    ...
    parentSoutien: "Pour cet enfant, votre intensité par éclats vaut moins que votre fiabilité régulière. Vous offrez des moments sublimes mais irréguliers — pour vous, l'éclat suffit ; pour lui, la régularité est le fondement affectif. Il apprendra à valoriser l'intensité au détriment de la fiabilité, comme vous. Et il cherchera l'amour dans les gens excitants plutôt que dans les gens sûrs.",
  ...
  "7-3": {
    ...
    parentSoutien: "Pour ce petit 3, votre « relax, amuse-toi » sur son sérieux est une non-reconnaissance. Il s'applique, finit ce qu'il commence, performe — vous voulez le protéger de la pression ; il reçoit que son sérieux n'est pas valorisé chez vous. Il apprendra à cacher son ambition. Ou à se sentir incompris dans ce qu'il a de plus fort.",
  ...
  "7-4": {
    ...
    parentSoutien: "Quand il est triste et que vous lui proposez mille distractions « pour lui changer les idées », vous croyez l'aider — vous lui refusez d'habiter sa tristesse. Il apprendra que ses émotions profondes sont des dérangements pour les autres. Il sera joyeux en surface avec vous, et malheureux en secret. Et vous penserez longtemps qu'il va bien.",
  ...
  "7-5": {
    ...
    parentSoutien: "Pour cet enfant, votre invitation joyeuse est un drainage déguisé. Il a besoin de calme, de silence, de retrait ; vous entrez avec un « viens, on fait un truc », vous trouvez « triste » qu'il reste seul. Chaque intrusion est une ponction d'énergie. Il apprendra à vous fuir pour se préserver. Votre maison deviendra, pour lui, un endroit où l'on ne peut pas se recharger.",
  ...
  "7-6": {
    ...
    parentSoutien: "Pour cet enfant, vos promesses sont des oui flottants — il les capte et son anxiété décuple. Il vous demande pour la troisième fois si vous serez bien là ce soir ; vous dites oui, mais vous avez déjà envie de sortir, et le ton vous trahit. Il apprendra que votre amour est réel mais pas fiable. Et la fiabilité, pour lui, c'est l'amour.",
  ...
  "7-7": {
    ...
    parentSoutien: "Vous vous comprenez à la seconde, vous êtes complices, vous ne vous ennuyez jamais — et personne n'atterrit. Personne ne finit, personne ne regarde la profondeur. Vous construisez ensemble une maison sans fondations. Elle sera merveilleuse à vivre tant qu'il n'y aura pas de tempête.",
    parentChallenge: "Cet enfant est votre miroir joyeux, et c'est précisément le problème. Vous vous complétez dans l'évitement, vous vous rassurez mutuellement dans la course à l'expérience. Sa guérison passe par la vôtre — l'un de vous deux doit apprendre à s'arrêter d'abord. Vous pouvez lui demander de le faire, ou accepter que c'est à vous, l'adulte, de montrer le chemin. La seconde option est moins drôle.",
  },
  "7-8": {
    ...
    parentSoutien: "Avec un 8 enfant, votre fuite du conflit est lue comme de la faiblesse. Il impose son point de vue, vous négociez, vous charmez, vous contournez — il perd le respect de votre autorité non parce que vous êtes mou·lle, mais parce que vous n'assumez pas votre centre. Il testera de plus en plus pour trouver un mur. Et tant qu'il n'en trouvera pas, il continuera.",
  ...
  "7-9": {
    ...
    parentSoutien: "Pour cet enfant, votre « oui » qu'il vous offre n'est pas une joie partagée — c'est sa propre lenteur reniée pour suivre votre rythme. Il accepte, il sourit, il suit le mouvement. Vous croyez qu'il s'amuse. Il deviendra un adulte qui ne sait plus bien ce qui le fatigue. Parce qu'il a trop appris à ne pas le dire.",
    parentChallenge: "Son calme passif vous fait presque peur — vous sentez que sans vous, il ne se passerait rien. Cet enfant vous donne l'illusion d'être indispensable. Mais regardez mieux : il s'efface d'autant plus que vous remplissez. Votre énergie devient la sienne, et il perd la sienne. Le réveiller demande de parfois, juste parfois, vous taire vous-même. C'est presque impossible pour vous.",
  },
  ...
  "8-1": {
    ...
    parentSoutien: "Pour ce petit 1 sérieux, vos taquineries robustes ne sont pas de la tendresse — c'est une menace à son centre. Vous le bousculez physiquement « pour le détendre », vous croyez lui insuffler de la force ; vos blagues atteignent son point fragile. Il apprendra à se rigidifier davantage, ou à se replier. Dans tous les cas, à ne pas se sentir en sécurité dans votre tendresse brute.",
  ...
  "8-2": {
    ...
    parentSoutien: "Pour ce petit 2 tendre, votre câlin vigoureux n'est pas de la douceur — c'est une force bienveillante qui le rééduque. Il vient à vous, vulnérable ; vous le serrez fort, grosse tape dans le dos. Il apprendra à apprécier votre amour, mais il ne saura jamais comment recevoir de la vraie tendresse. Votre puissance l'aura formaté.",
    parentChallenge: "Cet enfant vous offre ce que vous cherchez sans le savoir : la tendresse. Votre Luxure de vie se heurte à sa douceur comme à un mur de plumes — rien à combattre, juste à recevoir. Et recevoir vous est presque impossible. Votre flèche d'intégration vers le 2 passe par lui : il vous demande le plus vertigineux, poser les armes devant un être plus petit que vous, sans condition.",
  },
  "8-3": {
    ...
    parentSoutien: "Pour cet enfant, votre « ouais, bien » sec après une victoire est une douche froide. Il performe, il réussit, il attend votre fierté ; pour vous c'est déjà un engagement, pour lui qui vit de votre regard admiratif, c'est rien. Il en rajoutera, performera plus, montera le curseur — jusqu'à arracher un vrai « bravo », un jour peut-être. Il vendra son équilibre intérieur pour cette minute-là.",
  ...
  "8-4": {
    ...
    parentSoutien: "Pour cet enfant, votre « allez, redresse-toi, c'est rien » est un message clair : sa sensibilité est un problème à vos yeux. Vous vous êtes construit·e en décidant très jeune que pleurer rendait vulnérable aux coups. Mais lui n'a pas besoin de cette armure. À 10 ans il apprendra à cacher ce qu'il a de plus précieux. À 20 il ne saura plus où est sa sensibilité.",
    parentChallenge: "Vous avez choisi très tôt que la fragilité était dangereuse — ce choix a été nécessaire pour vous, sans doute. Mais cet enfant, lui, vous demande la permission de rester tendre. La lui refuser, c'est lui transmettre une blessure que vous n'aviez pas choisi d'hériter. La lui accorder demande de recroiser quelque chose en vous, enterré vers 8 ans.",
  },
  "8-5": {
    ...
    parentSoutien: "Pour cet enfant, votre « bouge, fais quelque chose » est une dévalorisation de son monde intérieur. Il se retire calmement pour lire, vous le poussez vers l'extérieur ; chaque fois, vous lui apprenez que sa vie intérieure est inférieure. Il obéira peut-être en surface. Sa richesse intérieure, elle, se rétrécira.",
  ...
  "8-6": {
    ...
    parentSoutien: "Pour ce petit 6 anxieux, votre « arrête de stresser, fonce » n'est pas une libération — c'est un mépris de sa peur. Il pose des questions, il doute ; vous voulez l'affranchir, il enregistre que vous ne voyez pas sa peur, que vous la jugez. Il apprendra à la cacher, à la refouler, à simuler la confiance devant vous. Ses doutes ne disparaîtront pas. Ils deviendront juste invisibles. Beaucoup plus toxiques.",
  ...
  "8-7": {
    ...
    parentSoutien: "Pour cet enfant, votre verticalité ressemble à une prison. Il démarre dix choses, change d'avis, n'est pas fiable ; votre sang monte : « tu t'engages ou pas ». Vous voulez le discipliner, il apprend à vous fuir pour préserver sa liberté, ou à se conformer par peur. Dans les deux cas, il perd. Et vous aussi.",
  ...
  "8-8": {
    ...
    parentSoutien: "Vous prenez vos affrontements pour de la saine confrontation — derrière, il y a un enfant qui apprend que l'amour passe par la domination. Vous êtes deux forts caractères, les batailles sont fréquentes et spectaculaires. Il aura du mal à construire des relations adultes douces. Il aura besoin de friction pour sentir l'attachement.",
    parentChallenge: "Cet enfant est votre miroir brut, et vos confrontations sont passionnantes autant que destructrices. Vous reconnaissez votre puissance en face de vous, et ça vous oblige à choisir : continuer à gagner sur lui, ou lui céder des territoires. Votre Luxure de contrôle déteste céder. Mais c'est le seul chemin pour qu'il apprenne que la force n'est pas l'opposé de la tendresse. Vous aussi.",
  },
  "8-9": {
    ...
    parentSoutien: "Pour cet enfant, votre intensité ne lui laisse pas d'oxygène. Il s'efface dès que vous entrez dans la pièce, sans mauvaise intention de votre part — c'est juste votre manière d'être, et il a appris à ne pas lutter. Vous croyez qu'il est d'accord avec tout. Il deviendra un adulte qui s'éteint sous les personnalités puissantes. Vous aurez formé son schéma amoureux sans le vouloir.",
    parentChallenge: "Son effacement vous convient trop bien. Pas de conflit, pas de résistance, tout roule. C'est précisément le piège. Cet enfant vous renvoie votre désintégration vers le 5 — la relation silencieuse, méfiante, où l'on ne s'engage pas vraiment. Il vous demande de faire l'effort le plus difficile : réduire votre intensité pour qu'il puisse simplement exister. Vous n'avez jamais appris à diminuer.",
  },
  ...
  "9-1": {
    ...
    parentSoutien: "Pour ce petit 1, votre « on verra, fais comme tu sens » n'est pas de la liberté — c'est l'absence de l'appui qu'il vous demande. Il réclame une décision claire, un cadre, une position nette ; vous lui offrez du flou. Il apprendra à se donner lui-même ses règles. Plus dures, plus rigides, plus punitives que les vôtres ne l'auraient jamais été.",
  ...
  "9-2": {
    ...
    parentSoutien: "Pour cet enfant, votre fusion silencieuse n'est pas un échange — c'est une absorption. Il vient à vous avec tout son amour, vous recevez en silence, fondu·e avec lui. Il a besoin de vous voir lui rendre quelque chose d'actif — un regard, un mot précis, une reconnaissance. Votre douceur passive le met dans le doute : est-il aimé, ou juste absorbé ? Il cherchera la différence sa vie durant.",
  ...
  "9-3": {
    ...
    parentSoutien: "Pour cet enfant qui vit du regard, votre paix intérieure est une absence. Il a besoin de vous pour briller, pour être applaudi ; vous trouvez ça fatigant, presque vaniteux, votre regard reste tiède. Il prendra votre tiédeur pour un désinvestissement, et redoublera d'efforts jusqu'à l'épuisement pour mériter l'éclat qui ne vient pas. Votre tranquillité est, pour lui, un manque actif.",
  ...
  "9-4": {
    ...
    parentSoutien: "Pour cet enfant en tempête, votre présence dissoute n'est pas un soutien — c'est un parent qui coule avec lui. Vous l'accueillez en silence, présent·e mais absorbé·e dans son état ; vous croyez être à ses côtés. Il a besoin d'une présence qui reste soi pendant sa tempête, pas d'un parent qui se laisse emporter. Votre empathie passive devient un risque pour lui.",
  ...
  "9-6": {
    ...
    parentSoutien: "Pour ce petit 6, votre « on verra, pas besoin de t'inquiéter » n'est pas un apaisement — c'est l'absence de l'appui qu'il vous demande. Il est anxieux, il veut savoir, il quête des repères ; votre fluidité rassurante est, pour lui, un vide angoissant. Il construira seul ses scénarios de sécurité. Beaucoup plus rigides que vous n'auriez imaginé.",
    parentChallenge: "Son anxiété active votre désintégration vers le 6 — vous devenez, en sa présence, plus méfiant·e, plus doutant·e. Cet enfant vous rappelle qu'on ne peut pas vivre dans la paix superficielle quand quelqu'un qu'on aime est dans la peur. Il vous tire hors de votre anesthésie — et votre Paresse, qui refusait d'y aller, n'a plus le choix. Vous lui devez votre réveil.",
  },
  "9-7": {
    ...
    parentSoutien: "Pour cet enfant, votre détachement tranquille n'est pas du respect pour sa liberté — c'est un désengagement. Il déborde d'énergie, d'idées, de projets ; vous suivez à votre rythme, posé·e. Il redoublera d'énergie pour vous atteindre, ou renoncera à vous chercher. Votre neutralité bienveillante est, pour lui, une forme d'abandon.",
  ...
  "9-8": {
    ...
    parentSoutien: "Avec un 8 enfant, céder pour préserver la paix est le pire des messages — il a besoin de trouver un mur. Il vous défie, teste, pousse ; votre réflexe est de contourner, de céder. Votre fuite du conflit lui confirme qu'il est le plus fort, et qu'il n'y a personne pour le cadrer. Il en aura peur. Vous n'aurez pas voulu le voir.",
  ...
  "9-9": {
    ...
    parentSoutien: "Vous croyez avoir réussi votre duo — mais personne n'exige rien, personne ne pousse, personne ne va au fond. Vous êtes deux paisibles, vous vivez en bonne entente fluide. Il apprend, de vous, que l'amour se résume à la paix sans friction. Il construira ses relations adultes dans ce moule, douces et confortables, mais aussi inertes. Il se demandera pourquoi rien ne le transporte.",
