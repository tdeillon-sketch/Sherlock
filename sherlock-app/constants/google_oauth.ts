...
// Utilisé par Expo Go et le web.
const WEB_CLIENT_ID = '635336758858-jg7h3s3jl5u43nqbk9s1rnrroam6visb.apps.googleusercontent.com';

// iOS Client ID (créé manuellement dans Google Cloud Console avec bundle
// com.thomasdeillon.sherlock). Utilisé par l'app standalone iOS (EAS Build
// / App Store).
const IOS_CLIENT_ID = '635336758858-dpqdvnbogs3pkcoe61d0shnb24qv53fg.apps.googleusercontent.com';

export const GOOGLE_OAUTH = {
  /** Used by Expo Go (web-based OAuth flow). */
  expoClientId:    WEB_CLIENT_ID,

  /** Used by the standalone iOS app (EAS Build / App Store). */
  iosClientId:     IOS_CLIENT_ID,

  /**
   * Used by the standalone Android app. À remplacer plus tard par un
   * Android Client ID dédié si tu publies sur Google Play.
   */
