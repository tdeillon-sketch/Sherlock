...
export const fr = {
  ...
  family: {
    ...
    anonHint: "Connectez-vous pour retrouver votre famille, ou créez un compte pour l'enregistrer sur tous vos appareils.",
    anonCta: 'Me connecter ou créer un compte',
  ...
  quiz: {
    ...
    nudgeText: 'Vous avez déjà fait {{n}} tests. Créez votre compte pour enregistrer votre famille et la retrouver sur tous vos appareils.',
    nudgeCta: 'Créer mon compte',
  ...
  saveProfile: {
    ...
    errorBody: "Le profil n'a pas pu être enregistré : pas de connexion, ou ce profil a été supprimé entre-temps. Réessayez.",
  ...
  auth: {
    ...
    benefit1: 'Votre famille et votre journal enregistrés',
    ...
    saveTitle: 'Connectez-vous ou créez votre compte',
    saveSubtitle: 'Pour enregistrer votre famille et votre journal, et les retrouver sur tous vos appareils. Ce que vous avez déjà fait est conservé. Déjà un compte ? Continuez avec le même compte Apple ou Google : vous retrouverez votre famille.',
  ...
  account: {
    ...
    noAccount: "Vous utilisez 5herlock sans compte. Créez-en un pour enregistrer votre famille et votre journal, et ne rien perdre en changeant de téléphone. Déjà un compte ? Connectez-vous ci-dessous.",
    createAccount: 'Me connecter ou créer un compte',
    deleteAnonBtn: 'Effacer mes données',
    ...
    reauthBody: 'Pour des raisons de sécurité, confirmez votre identité avec le même compte Apple ou Google : la suppression se terminera ensuite.',
  ...
  journal: {
    ...
    cardEdit: 'Modifier',
    anonHint: 'Un compte vous sera demandé pour garder vos réponses.',
