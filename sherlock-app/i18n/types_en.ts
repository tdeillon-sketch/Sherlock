...
export const TYPES_EN: Record<number, TypeContentEn> = {
  1: {
    ...
    belief: 'To be a good person, I must be perfect, righteous, beyond reproach. A mistake is a moral fault.',
  ...
  5: {
    ...
    metaphor: "The Investigator watches the world from afar, listens more than they speak, builds labyrinthine mental systems to understand how things work. They don't want to participate. They want to see. They want to know. And they want to be left alone to do it. This need for space is their signature — and often their puzzle for those who love them. Underneath, they guard their energy to feel competent and never be left overwhelmed.",
  ...
  8: {
    ...
    compulsionDesc: 'A thirst for intensity and control: pushing limits, taking up more space, never letting themselves be dominated or seen as vulnerable. Intensity as a way to stay in charge and feel their own vitality.',
